...
public class comActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button lifang;
    private Button Ncifang;
    private Button pingfanggen;
    ...
    private void initViewAndListener() {
        ...
        pingfang=findViewById(R.id.bt_pingfang);
        pingfang.setOnClickListener(this);

        lifang=findViewById(R.id.bt_lifang);
        lifang.setOnClickListener(this);

        Ncifang=findViewById(R.id.bt_Ncifang);
        Ncifang.setOnClickListener(this);

        pingfanggen=findViewById(R.id.pingfanggen);
        pingfanggen.setOnClickListener(this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.comp_item:
                ...
                break;
            case R.id.nom_item:
                Log.d("FirstActivity","启动第一个Activity");
...
//        }
        ...
        switch (v.getId()) {
            case R.id.bt_pingfang:
                ...
                if ((TextUtils.isEmpty(et_calc.getText())
                    ...
                    if(stringBuilder1.substring(index2-1).equals("+")||
                            ...
                            stringBuilder1.substring(index2-1).equals("*")||
                            stringBuilder1.substring(index2-1).equals("÷")||
                            stringBuilder1.substring(index2-1).equals("ⁿ")
                    ){
            ...
            case R.id.bt_Ncifang:
                ...
                opratorCalc(operatorNumber,"ⁿ");
                lastIsOperator = true;
                et_calc.setText(et_calc.getText() + "ⁿ");
                lastOperators = "ⁿ";
                break;
            case R.id.pingfanggen:
                ...
                if (Double.parseDouble(operatorNumber)<0) {
                    Toast.makeText(this,"负数不能开平方，请重新输入", Toast.LENGTH_LONG).show();
                    return;
                }
                opratorCalc(operatorNumber,"√▔");
                lastIsOperator = true;
    ...
    private void operate(String operatorNumber)
    {
        ...
        else
        {
            ...
            if(lastOperators.equals("ⁿ"))
            {
                firstNumber=pow(firstNumber,Double.parseDouble(operatorNumber));
            ...
            }if(lastOperators.equals("√▔"))
        {
            if(firstNumber==0){
                ...
                operatorNumbers.clear();
                operators.clear();
                Toast.makeText(this,"0不能开平方，请重新输入", Toast.LENGTH_LONG).show();
            }
